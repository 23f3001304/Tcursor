# src/editor/panels/cursor/CursorPackGrid.tsx
...
- `src/editor/panels/cursor/CursorPackField.tsx` - renders it once the pack list resolves (the fetch and the import moved there in the panel pass; `CursorPanel` no longer touches either)
