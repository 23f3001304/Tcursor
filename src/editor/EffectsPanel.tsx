...
import type { ClickFxSettings, ClickFxStyle, SpotlightMode } from "../hud/settings";
import { Switch, Slider, Picker } from "./Controls";
  ...
  return (
    <div className="e-panel e-insp">
      <div className="e-insphdr">
        <h2>Effects & Layers</h2>
        <button className="e-gst" title="Close" onClick={onClose}><IconX size={16} /></button>
      </div>
      <p className="e-lede">Drag these element pills to timelines, or configure click ripples and cursor spotlight overrides.</p>

      <EffectPills onAddZoom={onAddZoom} onAddSpotlight={onAddSpotlight} onAddLayout={onAddLayout} />

      {/* Click ripples */}
      <div className="e-field" style={{ borderTop: "1px solid var(--e-border2)", paddingTop: 14 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: 13, color: "var(--e-fg)" }}>Click animations</span>
      ...
      <div className="e-field" style={{ borderTop: "1px solid var(--e-border2)", paddingTop: 14 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: 13, color: "var(--e-fg)" }}>Spotlight always on</span>
