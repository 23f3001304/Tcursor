...
- `smoothing_off_is_bit_identical` (unit test, `jank_filter_tests.rs`): an FNV-1a fingerprint of all 721 `(scale, cx, cy)` samples of the probe scene equals the value captured from the build before this module existed.
