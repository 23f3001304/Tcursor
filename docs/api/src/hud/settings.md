...
- `src/hud/settings.ts` - `ModeAppearance.cam_shape`
- `src/hud/appearanceFields.ts` - `SHAPES` constant, `MODE_HAS_SHAPE` map
- `src/hud/SettingsAppearance.tsx` - renders the shape picker
...
- `src/hud/settings.ts` - `ModeAppearance.cam_corner`
- `src/hud/appearanceFields.ts` - `CORNERS` constant, `MODE_HAS_CORNER` map
- `src/hud/SettingsAppearance.tsx` - renders the corner picker
...
- `src/hud/settings.ts` - `AppearanceSettings` holds one per mode
- `src/hud/appearanceFields.ts` - `DEFAULT_APPEARANCE` typed as `AppearanceSettings`
- `src/hud/SettingsAppearance.tsx` - reads and mutates per-mode appearance
- `src/hud/LayoutPreview.tsx` - renders a thumbnail of the current layout
...
- `src/hud/settings.ts` - `Settings.appearance`
- `src/hud/appearanceFields.ts` - `DEFAULT_APPEARANCE`
- `src/hud/SettingsAppearance.tsx` - indexed by the active `ModeKey`
...
- `src/hud/settings.ts` - `InterfaceSettings.theme`
- `src/hud/applyTheme.ts` - theme resolution logic
...
- `src/hud/settings.ts` - `Settings.ui`
- `src/hud/applyTheme.ts` - consumes both fields
- `src/hud/SettingsInterface.tsx` - renders theme and accent pickers
...
- `src/hud/settings.ts` - `CursorSettings.style`
- `src/hud/SettingsCursor.tsx` - renders the style picker
...
- `src/hud/settings.ts` - `Settings.cursor`
- `src/hud/SettingsCursor.tsx` - renders all cursor controls
...
- `src/hud/settings.ts` - `ClickFxSettings.style`
- `src/hud/SettingsClickFx.tsx` - renders the style picker
...
- `src/hud/settings.ts` - `ClickFxSettings.spotlight_mode`
- `src/hud/SettingsClickFx.tsx` - renders the spotlight-mode picker
...
- `src/hud/settings.ts` - `ClickFxSettings.video_fx_mode`
- `src/hud/SettingsClickFx.tsx` - renders the video-fx picker
...
- `src/hud/settings.ts` - `Settings.zoom`
- `src/hud/SettingsZoom.tsx` - renders all zoom controls
...
- `src/hud/settings.ts` - `Settings.clickfx`
- `src/hud/SettingsClickFx.tsx` - renders all click-fx and spotlight controls
...
- `src/hud/settings.ts` - `Settings.hotkeys`
- `src/hud/SettingsHotkeys.tsx` - renders the hotkey binding editor
