...
impl EditState {
    ...
    pub(crate) fn load(paths: &ProjectPaths, actions: &[ActionEvent], layout: &Layout, sw: u32, sh: u32) -> Self {
        ...
        let track = LayoutTrack::new(layout_acts.as_deref().unwrap_or(actions), &settings.appearance,
...
mod tests {
    ...
    ///   TCURSOR_REC=<folder> cargo test --lib export::render_edit::tests::reload -- --ignored --nocapture
    #[test]
    #[ignore]
