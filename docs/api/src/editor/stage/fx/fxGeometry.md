# src/editor/stage/fx/fxGeometry.ts
...
- `src/editor/hooks/stage/useCompositeLoop.ts` - once per composite tick, for the ripple draw, the FX-overlay request, and the cursor projection.
