# src-tauri/src/export/cursor/pack_import.rs
...
- `src/lib/ipc.ts` (`importCursorPack`) - the TS wrapper
- `src/editor/panels/CursorPanel.tsx` - calls after the user picks a folder via the Tauri dialog plugin, then selects the returned pack
