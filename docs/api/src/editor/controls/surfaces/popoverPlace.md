# src/editor/controls/surfaces/popoverPlace.ts
...
- `src/editor/controls/surfaces/Tooltip.tsx` - `placeBeside`.
- `src/editor/controls/fields/Picker.tsx` - `placeStacked`.
- `src/editor/timeline/lanes/CameraCurvePop.tsx` - `placeStackedCentred`.
