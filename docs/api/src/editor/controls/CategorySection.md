# src/editor/controls/CategorySection.tsx
...
- `src/editor/panels/CursorPackGrid.tsx` - one section per pack STYLE (`packCategories.md`).
- `src/editor/panels/WallpaperGrid.tsx` (`WallpaperTab`) - one per wallpaper group, plus "Your file".
- `src/editor/panels/GradientTab.tsx` - the gradient presets.
