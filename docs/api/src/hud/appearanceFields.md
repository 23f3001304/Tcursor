...
- `src/hud/settings.ts` - `AppearanceSettings` is indexed by this type
- `src/hud/SettingsAppearance.tsx` - selects which knobs to render for the active mode
- `src/hud/LayoutPreview.tsx` - picks the preview geometry
...
- `src/hud/SettingsAppearance.tsx` - renders one range input per active knob
...
- `src/hud/SettingsAppearance.tsx` - filters the slider list for the selected mode
...
- `src/hud/SettingsAppearance.tsx` - conditionally renders the shape picker row
...
- `src/hud/SettingsAppearance.tsx` - conditionally renders the corner picker row
...
- `src/hud/SettingsAppearance.tsx` - reset-to-defaults button
