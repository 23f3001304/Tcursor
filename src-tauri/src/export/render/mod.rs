...
use crate::export::{settings::Resolution, types::{Camera, FramePoint, Layout, ZoomConfig, ZoomRegion}};
...
impl FrameRenderer {
    ...
    /// Advance the camera sim to output time `t` (ms) and return the full pose. Cheap: math only, no
