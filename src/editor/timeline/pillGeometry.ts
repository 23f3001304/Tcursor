 ...
 *  (`.e-trimhandle`, timeline.css), which sits at that SAME x position whenever the clip is
 ...
 *  own left resize handle (`.e-zh`, 11px - the pill's first flex child, timeline.css) sat exactly
 ...
 *  widths; `timeline.css` also lifts a pill's own z-index above the trim handle's (6) while it's
