# src/editor/controls/Segmented.tsx
...
- `src/editor/panels/CursorPanel.tsx` - cursor style.
- `src/editor/panels/BackgroundPanel.tsx` - background kind.
- `src/editor/panels/CameraPanel.tsx` - webcam shape, aspect, dock location.
