 ...
 *  linear / smoothstep / ease-out-back spring. Exported so other per-frame TS mirrors
 *  (e.g. camMoveAt) share this single curve implementation instead of redefining it. */
