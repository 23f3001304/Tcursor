# src/editor/controls/surfaces/Disclosure.tsx
...
- `src/editor/panels/background/BackgroundPanel.tsx` (`id="background"`) - Look, Frame and Accent Colors.
- `src/editor/panels/cursor/CursorPanel.tsx` (`id="cursor"`) - Motion and Click.
- `src/editor/panels/camera/CameraPanel.tsx` (`id="camera"`) - the ring, and the two margin nudges.
