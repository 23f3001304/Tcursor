# src-tauri/src/export/cursor/pack/packlist.rs
...
- `src-tauri/src/export/cursor/pack/pack_import.rs` - `import_cursor_pack` returns `imported_info`
- `src/editor/panels/cursor/CursorPackGrid.tsx` - the whole grid is driven by `CursorPackInfo`
