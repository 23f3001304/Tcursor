...
import { Switch, Picker, NumberField, Slider } from "./Controls";
  ...
  return (
    <label className="e-field">
      ...
      <Slider min={min} max={max} step={step} value={value ?? defaultValue} disabled={value === undefined}
        onChange={onChange} accentColor="var(--accent, #ef4444)" />
    </label>
  );
}
...
export function EffectInspector({ effect, dur, settings, onApply, onClose }: {
  ...
  return (
    <div className="e-panel e-insp">
      ...
      <p className="e-lede">Dims everything but the cursor for this span. Drag the block on the timeline to move it.</p>
      ...
      <div className="e-field2">
        <label className="e-field"><span className="e-fl">Fade in (s)</span>
        ...
        <label className="e-field"><span className="e-fl">Fade out (s)</span>
