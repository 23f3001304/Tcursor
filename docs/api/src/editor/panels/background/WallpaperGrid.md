# src/editor/panels/background/WallpaperGrid.tsx
...
- `src/editor/panels/background/BackgroundPanel.tsx` - rendered for `tab === "wallpapers"`.
- `src/editor/panels/background/GradientTab.tsx` uses `TileGrid` and `thumbGroups` for its own preset sections.
