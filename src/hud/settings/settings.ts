...
export interface InterfaceSettings {
  ...
  animated_brand: boolean;
  interface_effects: boolean;
  ai_choreography: boolean;
}
...
export type CaptionAnim = "none" | "fade" | "rise" | "pop" | "words";
export interface CaptionStyle {
  ...
  highlight_color: [number, number, number] | null;
  pill_color: [number, number, number];
  pill_alpha: number;
